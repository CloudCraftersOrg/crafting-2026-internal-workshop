...
Run locally:
    uvicorn workshop_agent.server:app --host 0.0.0.0 --port 8080 --reload
"""
...
app = FastAPI(title="Workshop Agent (Strands)", version="0.2.0")
...
def _get_or_create_session(session_id: str) -> dict[str, Any]:
    ...
    if session_id not in _SESSIONS:
        ...
        # Baseline tools: just the Bedrock KB retriever. Workshop teams add
        # MCP servers / custom tools by appending to this list.
        tools: list[Any] = []
