...
# Knowledge Base ID — set as BEDROCK_KNOWLEDGE_BASE_ID in the runtime env
output "knowledge_base_id" {
  value = aws_bedrockagent_knowledge_base.harry_potter.id
}

# Upload Harry Potter documents here then trigger an ingestion sync job
output "kb_s3_bucket" {
